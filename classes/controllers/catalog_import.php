...
namespace contentmarketplace_levitate\controllers;
...
use totara_mvc\view;
use moodle_url;	//added by human-logic
...
final class catalog_import extends base_catalog_import {
	...
	global $CFG,$PAGE;
	$PAGE->requires->js(new moodle_url($CFG->wwwroot.'/totara/contentmarketplace/contentmarketplaces/levitate/js/thumbnail.js')); //added by human-logic
