...
final class create_course_form extends \totara_form\form {
    ...
    public function definition() {
        ...
        $create = new radios('create', get_string('course_creation', 'contentmarketplace_levitate'), $options);
        $create->set_attribute('required', 1);
        $create->add_help_button('course_creation', 'contentmarketplace_levitate');
        $settings->add($create);
