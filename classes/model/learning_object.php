...
namespace contentmarketplace_levitate\model;

use coding_exception;
use contentmarketplace_levitate\api;
use contentmarketplace_levitate\entity\learning_object as learning_object_entity;
...
/**
 * A hybrid object that serves as a central place to obtain data about a levitate object, with some data being stored in the DB, and
 * some being fetched from the levitate API cache.
 *
 * Entity properties:
 ...
 *
 * @package contentmarketplace_levitate\model
 */
class learning_object extends model implements detailed_model {
    ...
    /**
     * Load a model instance from a levitate learning object ID (external, not Totara's ID)
     *
     * @param int $learning_object_id
     * @param api|null $api Use existing levitate API instance in order to fetch data from the cache
    ...
    public static function load_by_external_id(
        ...
        if (!$create_if_does_not_exist) {
            ...
            throw new coding_exception("The levitate learning object with ID $learning_object_id does not exist in the $table table.");
        }
    ...
    public static function get_marketplace_component(): string {
        return 'contentmarketplace_levitate';
    }
    ...
    /**
     * Fetch the levitate learning object data from the API cache.
     *
     * @return object
     */
