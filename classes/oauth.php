...
final class oauth {
    ...
    const ENDPOINT = 'https://auth.levitate.com';
    ...
    public static function get_authorize_url($redirect_uri, $state) {
        ...
        if (defined('BEHAT_SITE_RUNNING') || defined('levitate_MOCK_API_ENDPOINTS')) {
            $url = '/totara/contentmarketplace/contentmarketplaces/levitate/tests/behat/fixtures/oauth/authorize.php';
        }
