...
foreach ($pages as $page) {
    $tabs[] = new tabobject(
        ...
        get_string($page, 'contentmarketplace_levitate')
    );
}

echo $OUTPUT->heading('Levitate settings');
echo $OUTPUT->tabtree($tabs, $tab);

if (in_array($tab, $pages)) {
    // \contentmarketplace_levitate\contentmarketplace::update_data();
    include($CFG->dirroot . '/totara/contentmarketplace/contentmarketplaces/levitate/'. $tab . '.php');
}
