...
use contentmarketplace_levitate\mock_playback_curl;
 ...
 */
class contentmarketplace_levitate_oauth_rest_client_testcase extends basic_testcase {
    ...
    public function test_get_with_token_refresh() {
        ...
        $curl->record(
            'https://auth.levitate.com/oauth/token',
            [
                'HEADER' => 0,
                'HTTPHEADER' => [
            ...
            [
                'url' => 'https://auth.levitate.com/oauth/token',
                'http_code' => 200,
                'content_type' => 'application/json',
            ],
            '{' .
