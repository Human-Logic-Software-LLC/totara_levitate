...
if ($authorize) {
    ...
    $PAGE->set_url(new moodle_url('/totara/contentmarketplace/contentmarketplaces/levitate/tests/behat/fixtures/oauth/authorize.php'));
    $PAGE->set_context($context);
    echo $OUTPUT->heading('Allow Totara to access levitate');
