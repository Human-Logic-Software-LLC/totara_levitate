...
use contentmarketplace_levitate\testing\generator;
use core_phpunit\testcase;

/**
 * @group totara_contentmarketplace
 */
class contentmarketplace_levitate_learning_object_model_testcase extends testcase {
    ...
    public function test_load_from_external_id(): void {
        ...
        $this->expectExceptionMessage(
            "The levitate learning object with ID 5678 does not exist in the marketplace_levitate_learning_object table."
        );
     ...
     * we need to ensure that they get fetched from the cache/levitate's API when requested.
     *
     * @param int $id
     * @dataProvider mocked_levitate_learning_objects_provider
     */
     ...
     * @return string[]
     */
    public function mocked_levitate_learning_objects_provider(): array {
        return [
